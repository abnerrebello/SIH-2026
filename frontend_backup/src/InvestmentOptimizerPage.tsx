    ...
    <div className="page-stack investment-page">
      ...
      <section className="investment-workbench investment-workbench-v2">
        <div className="investment-workbench-header">
          ...
          >
            <Zap size={16} />
            {mutation.isPending ? "Calculating plan…" : result && !hasEdited ? "Recalculate plan" : "Find optimal plan"}
          </button>
        </div>
        ...
        {mutation.isError && (
          <div className="investment-error">
            ...
            <span>Check that the security API is running and try again.</span>
          </div>
        )}
      </section>
            ...
            <article className="investment-action-card investment-action-card-v2" key={`${action.vulnerability_id}-${action.asset_id}-${action.cve_id}`}>
              ...
              <div className="investment-action-content">
                <div className="investment-action-heading">
                  ...
                  <div className="investment-impact-number"><span>Security impact</span><strong>+{action.security_impact.toFixed(1)}%</strong></div>
                </div>
  ...
  return (
    <label className="investment-constraint investment-constraint-v2">
      ...
      <div className="investment-constraint-footer">
        <small>{hint}</small>
        {formatValue && <strong>₹{formatValue(value)}</strong>}
      </div>
    </label>
  );
}
