...
class EnvironmentImportService:
    ...
    def __init__(
        ...
        # Assets created during the CURRENT import only.
        # This prevents a same-name old asset from receiving
        # the new import's relationships or vulnerability mappings.
        self._import_assets: dict[str, Asset] = {}
    ...
    def import_csv(
        ...
        try:
            ...
            # Create relationships and vulnerability mappings.
            for row_number, raw_row in enumerate(
                rows,
                start=2,
            ):
            ...
            # if the new environment fails, restore the old one.
            db.rollback()

            result.errors.append(
                f"Environment import failed: "
    ...
    def _create_asset(
        ...
        # Relationships/mappings from this CSV resolve
        # to the asset created by this import.
        self._import_assets[name] = asset
    ...
    def _create_relationship(
        ...
        # Prefer assets created by THIS import.
        source = self._import_assets.get(source_name)
        ...
        target = self._import_assets.get(target_name)
    ...
    def _create_mapping(
        ...
        # Prefer asset created by THIS import.
        asset = self._import_assets.get(asset_name)
